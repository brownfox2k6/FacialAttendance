...
class RegisterWindow(QMainWindow, UI):
    def __init__(self):
        ...
        self.guide_label.setGeometry(380, 330, 331, 61)
    ...
    def start_registering(self):
        ...
        info = (
            self.trans("Please recheck your information carefully, "
                          + "then click \"Yes\" to start recording face, "
                          + "otherwise click \"No\" to edit your information.") + '\n',
    ...
    def closeEvent(self,event): print("quieiee")
