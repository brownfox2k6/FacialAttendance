...
class StudentRepository(db_access):
    ...
    def add_student(self, student):
        ...
        """, (student.student_id, student.student_name,
              student.class_name, student.parent_email))

    def get_student(self, student_id):
        return [StudentEntity(*x) for x in self.query(
            "SELECT * FROM students WHERE student_id=?", (student_id, ))][0]

    def get_all_students(self):
        return [StudentEntity(*x) for x in self.query("SELECT * FROM students;")]
